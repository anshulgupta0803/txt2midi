...
from txt2midi.track import Track
from txt2midi.instruments import *
...
def convert(ui):
	...
	with open(location + '/schema.json') as schemaFile:
	...
	return ui.getOutputFolder() + compositionName + ".mid"
